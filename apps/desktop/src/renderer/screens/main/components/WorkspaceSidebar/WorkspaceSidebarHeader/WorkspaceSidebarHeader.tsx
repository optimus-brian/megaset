...
import { SidebarEntryButtons } from "./SidebarEntryButtons";
...
export function WorkspaceSidebarHeader({
	...
	const tasksVisible = useModuleVisibility().visibility.tasks;
	...
	if (isCollapsed) {
		return (
			<div className="flex flex-col items-center border-b border-border py-2 gap-2">
				<SidebarEntryButtons isCollapsed placement="before-upstream" />
				...
				<SidebarEntryButtons isCollapsed placement="after-upstream" />
	...
	return (
		<div className="flex flex-col gap-1 border-b border-border px-2 pt-2 pb-2">
			<SidebarEntryButtons isCollapsed={false} placement="before-upstream" />
			...
			<SidebarEntryButtons isCollapsed={false} placement="after-upstream" />
