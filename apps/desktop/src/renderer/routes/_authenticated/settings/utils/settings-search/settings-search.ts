...
export const SETTING_ITEM_ID = {
	...
	GIT_PROVIDER_ONEDEV: "git-provider-onedev",
...
export const SETTING_ITEM_VARIANT: Record<SettingItemId, SettingVariant> = {
	...
	[SETTING_ITEM_ID.GIT_PROVIDER_GITHUB]: "shared",
	[SETTING_ITEM_ID.GIT_PROVIDER_ONEDEV]: "shared",
	[SETTING_ITEM_ID.GIT_PROJECTS_DIRECTORY]: "shared",
...
export const SETTINGS_ITEMS: SettingsItem[] = [
	...
	{
		id: SETTING_ITEM_ID.GIT_PROVIDER_ONEDEV,
		section: "git",
		title: "OneDev provider",
		description:
			"Connect a self-hosted OneDev instance with a personal access token to sync issues",
		keywords: [
			"onedev",
			"git",
			"provider",
